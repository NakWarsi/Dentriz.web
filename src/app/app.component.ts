...
export class AppComponent {
  ...
  private setMetaTags() {
    this.meta.addTags([
      { name: 'description', content: 'Best dentist in Wakad and Hinjewadi, Pune. Top dental clinic offering cosmetic dentistry, dental implants, family dentistry, teeth cleaning, veneers, and pediatric dentistry services. Call 932-144-9313 for appointments.' },
